    ...
    testList "Thoth.Json.Encode" [
        ...
        testList "Basic" [
            ...
            testCase "a datetimeOffset works" <| fun _ ->
                let expected = "\"2018-07-02T12:23:45.0000000\\u002B02:00\"" // TODO: System.Text.Json does some funny business with the '+' char
                let actual =
            ...
            testCase "Encode.Auto.generateEncoder throws for field using a non optional class" <| fun _ ->
                let expected = String.normalize """Cannot generate auto encoder for Tests.Types.BaseClass. Please pass an extra encoder.
...
Documentation available at: https://thoth-org.github.io/Thoth.Json/documentation/auto/extra-coders.html#ready-to-use-extra-coders"""
                ...
                let errorMsg =
                    try
                        let _ = Encode.Auto.generateEncoder<RecordWithRequiredClass>(caseStrategy = CamelCase)
                        ""
                    with ex ->
                        ex.Message
